...
using namespace db::details::firebird;

firebird_statement_backend::firebird_statement_backend(firebird_session_backend &session)
: session_(session), stmtp_(0), sqldap_(NULL), sqlda2p_(NULL), boundByName_(false),
boundByPos_(false), rowsFetched_(0), intoType_(eStandard), useType_(eStandard),
procedure_(false)
{}
