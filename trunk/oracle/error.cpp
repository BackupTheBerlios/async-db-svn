...
using namespace db::details::oracle;
...
void db::details::oracle::get_error_details(sword res, OCIError *errhp,
...
void db::details::oracle::throw_oracle_soci_error(sword res, OCIError *errhp)
{
    std::string msg;
    int errNum;
